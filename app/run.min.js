(function(){/*
 MIT License (c) copyright B Cavalier & J Hann  MIT License (c) copyright 2011-2013 original author or authors  MIT License (c) copyright 2011-2013 original author or authors  MIT License (c) copyright 2010-2013 original author or authors  MIT License (c) copyright B Cavalier & J Hann  MIT License (c) copyright B Cavalier & J Hann  MIT License (c) copyright B Cavalier & J Hann  MIT License (c) copyright B Cavalier & J Hann  MIT License (c) copyright B Cavalier & J Hann  MIT License (c) copyright B Cavalier & J Hann  MIT License (c) copyright B Cavalier & J Hann  MIT License (c) copyright original author or authors  MIT License (c) copyright B Cavalier & J Hann  MIT License (c) copyright B Cavalier & J Hann  MIT License (c) copyright B Cavalier & J Hann  MIT License (c) copyright B Cavalier & J Hann  MIT License (c) copyright B Cavalier & J Hann  MIT License (c) copyright B Cavalier & J Hann  MIT License (c) copyright B Cavalier & J Hann  MIT License (c) copyright B Cavalier & J Hann  MIT License (c) copyright B Cavalier & J Hann  MIT License (c) copyright B Cavalier & J Hann  MIT License (c) copyright B Cavalier & J Hann  MIT License (c) copyright B Cavalier & J Hann  MIT License (c) copyright 2010-2013 original author or authors  MIT License (c) copyright B Cavalier & J Hann  MIT License (c) copyright B Cavalier & J Hann  MIT License (c) copyright B Cavalier & J Hann  MIT License (c) copyright B Cavalier & J Hann  MIT License (c) copyright 2010-2013 original author or authors  MIT License (c) copyright B Cavalier & J Hann  MIT License (c) copyright B Cavalier & J Hann  MIT License (c) copyright B Cavalier & J Hann  MIT License (c) copyright B Cavalier & J Hann  MIT License (c) copyright B Cavalier & J Hann  MIT License (c) copyright B Cavalier & J Hann  MIT License (c) copyright B Cavalier & J Hann  MIT License (c) copyright B Cavalier & J Hann  MIT License (c) copyright B Cavalier & J Hann */
...
define("poly/array",["poly/lib/_base"],function(a){function q(b){return"[object String]"==a.toString(b)?b.split(""):m(b)}function d(a){return"[object Array]"==h.call(a)}function f(c){return a.isFunction(b[l[c]])}function j(){return 1}function e(a){return a}function c(b,c,k,l,g,h){var m;b=q(b);m=b.length>>>0;g===p&&(g=0);h||(h=1);m=0>h?-1:m;if(!a.isFunction(c))throw new TypeError(c+" is not a function");if(g==m)return!1;if(g<=m^0<h)throw new TypeError("Invalid length or starting index");for(;g!=m;g+=
h)if(g in b&&!k(c.call(l,b[g],g,b),g,b[g]))return!1;return!0}var b=Array.prototype,h={}.toString,l,m,r,g,p;l={"array-foreach":"forEach","array-every":"every","array-some":"some","array-map":"map","array-filter":"filter","array-reduce":"reduce","array-reduceright":"reduceRight","array-indexof":"indexOf","array-lastindexof":"lastIndexOf"};m=a.createCaster(Object,"Array");f("array-foreach")||(b.forEach=function(a){c(this,a,j,arguments[1])});f("array-every")||(b.every=function(a){return c(this,a,e,arguments[1])});
f("array-some")||(b.some=function(a){return c(this,a,function(a){return!a},arguments[1])});f("array-map")||(b.map=function(a){var b;b=Array(this.length);c(this,a,function(a,c){b[c]=a;return 1},arguments[1]);return b});f("array-filter")||(b.filter=function(a,b){var k;k=[];c(this,a,function(a,b,c){a&&k.push(c);return 1},b);return k});if(!f("array-reduce")||!f("array-reduceright"))r=function(a,b,k,g){var l,h,m;h=m=0<b?-1:q(this).length>>>0;if(g)l=k;else if(c(this,e,function(a,b){l=a;m=b},null,h+b,b),
m==h)throw new TypeError;c(this,function(b,k,c){l=a(l,b,k,c)},j,null,m+b,b);return l},f("array-reduce")||(b.reduce=function(a){return r.call(this,a,1,arguments[1],1<arguments.length)}),f("array-reduceright")||(b.reduceRight=function(a){return r.call(this,a,-1,arguments[1],1<arguments.length)});if(!f("array-indexof")||!f("array-lastindexof"))g=function(a,b,k,g){var l=q(a).length>>>0,h=-1;k=isNaN(k)?g?0:l-1:Number(k);0>k&&(k=l+k-1);c(a,e,function(a,k){a===b&&(h=k);return-1==h},null,k,g?1:-1);return h},
f("array-indexof")||(b.indexOf=function(a){return g(this,a,arguments[1],!0)}),f("array-lastindexof")||(b.lastIndexOf=function(a){return g(this,a,arguments[1],!1)});Array.isArray||(Array.isArray=d)});
...
define("curl/plugin/i18n!app/subheader/strings",function(){return{phrases:["The <em>un</em>framework: Free your code","Create, modify, and <em>test</em> with ease","Scale your team as your app grows","Use the web. Don't circumvent it"]}});define("curl/plugin/i18n!hello/app/strings.js",function(){return{name:"What's your name?",hint:"Type your name",hello:"Hello"}});
define("curl/plugin/i18n!contacts/app/edit/strings",function(){return{firstName:"First Name",lastName:"Last Name",phone:"Phone Number",email:"E-Mail",save:"Save",clear:"Clear"}});
...
define("app/homepage-sample/spec",{homepageCode:{wire:{spec:"app/tabs/spec",provide:{root:{$ref:"dom.first!.cujo-homepage-container .code"},collection:{$ref:"homepageSources"}}}},homepageSources:{create:"cola/Collection"},homepageSourcesData:{create:{module:"cola/adapter/Array",args:[[{id:1,name:"main.js",content:{module:"highlight!app/main.js"}},{id:2,name:"selectText.js",content:{module:"highlight!app/subheader/selectText.js"}},{id:3,name:"selectText-test.js",content:{module:"highlight!test/subheader/selectText-test.js"}}]]},
bind:{$ref:"homepageSources"}},$plugins:["wire/dom","wire/on","cola"]});(function(a){a("app/subheader/selectText",function(){function a(d){return Math.floor(Math.random()*d)}return function(d,f){var j=d&&d.length;return j?d[(f||a)(j)]:""}})})("function"===typeof define&&define.amd?define:function(a){module.exports=a()});define("curl/plugin/text!app/subheader/template.html",function(){return'<h2 class="subheader">${text}</h2>\n'});
...
f,!1);return function(){a.removeEventListener(b,f,!1)}}:function(a,b){a.attachEvent("on"+b,f);return function(){a.detachEvent(b,f)}};q&&!f()&&(p=[r(a,"load"),r(q,"readystatechange"),r(a,"DOMContentLoaded")],t=setTimeout(j,m));define("curl/domReady",function(){function a(c){l?c():b.push(c)}a.then=a;a.amd=!0;return a})})(this,this.document);
...
(function(a){a("when/when",function(){function a(b,c,k,h){return f(b).then(c,k,h)}function d(a){this.then=a}function f(a){return j(function(b){b(a)})}function j(a){function c(a){m&&(n=e(a),l(m,n),m=y)}function k(a){c(b(a))}function g(a){m&&l(m,h(a))}var n,m=[];try{a(c,k,g)}catch(f){k(f)}return new d(function(a,b,c){return j(function(k,h,g){m?m.push(function(l){l.then(a,b,c).then(k,h,g)}):p(function(){n.then(a,b,c).then(k,h,g)})})})}function e(a){return a instanceof d?a:a!==Object(a)?c(a):j(function(b,
k,h){p(function(){try{var g=a.then;"function"===typeof g?v(g,a,b,k,h):b(c(a))}catch(l){k(l)}})})}function c(a){var c=new d(function(k){try{return"function"==typeof k?e(k(a)):c}catch(h){return b(h)}});return c}function b(a){var c=new d(function(k,h){try{return"function"==typeof h?e(h(a)):c}catch(g){return b(g)}});return c}function h(a){var b=new d(function(c,k,g){try{return"function"==typeof g?h(g(a)):b}catch(l){return h(l)}});return b}function l(a,b){p(function(){for(var c,k=0;c=a[k++];)c(b)})}function m(b,
c,h,g,l){n(2,arguments);return a(b,function(b){return j(function(h,g,l){function n(a){s(a)}function m(a){j(a)}var p,d,e,f,j,s,t,u;t=b.length>>>0;p=Math.max(0,Math.min(c,t));e=[];d=t-p+1;f=[];if(p){s=function(a){f.push(a);--d||(j=s=k,g(f))};j=function(a){e.push(a);--p||(j=s=k,h(e))};for(u=0;u<t;++u)u in b&&a(b[u],m,n,l)}else h(e)}).then(h,g,l)})}function r(a,b,c,k){n(1,arguments);return g(a,s).then(b,c,k)}function g(b,c){return a(b,function(b){return j(function(k,h,g){var l,n,m,p,e;m=n=b.length>>>
0;l=[];if(m){p=function(b,n){a(b,c).then(function(a){l[n]=a;--m||k(l)},h,g)};for(e=0;e<n;e++)e in b?p(b[e],e):--m}else k(l)})})}function p(a){1===z.push(a)&&x(t)}function t(){for(var a,b=0;a=z[b++];)a();z=[]}function n(a,b){for(var c,k=b.length;k>a;)if(c=b[--k],null!=c&&"function"!=typeof c)throw Error("arg "+k+" must be a function");}function k(){}function s(a){return a}a.defer=function(){var a,c,k;a={promise:y,resolve:y,reject:y,notify:y,resolver:{resolve:y,reject:y,notify:y}};a.promise=c=j(function(h,
g,l){a.resolve=a.resolver.resolve=function(a){if(k)return f(a);k=!0;h(a);return c};a.reject=a.resolver.reject=function(a){if(k)return f(b(a));k=!0;g(a);return c};a.notify=a.resolver.notify=function(a){l(a);return a}});return a};a.resolve=f;a.reject=function(c){return a(c,b)};a.join=function(){return g(arguments,s)};a.all=r;a.map=g;a.reduce=function(b,c){var k=v(w,arguments,1);return a(b,function(b){var h;h=b.length;k[0]=function(b,k,g){return a(b,function(b){return a(k,function(a){return c(b,a,g,
h)})})};return u.apply(b,k)})};a.any=function(a,b,c,k){return m(a,1,function(a){return b?b(a[0]):a[0]},c,k)};a.some=m;a.isPromise=function(a){return a&&"function"===typeof a.then};d.prototype={otherwise:function(a){return this.then(y,a)},ensure:function(a){function b(){return f(a())}return this.then(b,b).yield(this)},yield:function(a){return this.then(function(){return a})},spread:function(a){return this.then(function(b){return r(b,function(b){return a.apply(y,b)})})},always:function(a,b){return this.then(a,
a,b)}};var u,w,v,x,z,E,A,B,y;z=[];E=setTimeout;x="function"===typeof setImmediate?"undefined"===typeof window?setImmediate:setImmediate.bind(window):"object"===typeof process&&process.nextTick?process.nextTick:function(a){E(a,0)};A=Function.prototype;B=A.call;v=A.bind?B.bind(B):function(a,b){return a.apply(b,w.call(arguments,2))};A=[];w=A.slice;u=A.reduce||function(a){var b,c,k,h,g;g=0;b=Object(this);h=b.length>>>0;c=arguments;if(1>=c.length)for(;;){if(g in b){k=b[g++];break}if(++g>=h)throw new TypeError;
}else k=c[1];for(;g<h;++g)g in b&&(k=a(k,b[g],g,b));return k};return a})})("function"===typeof define&&define.amd?define:function(a){module.exports=a()});
...
m,b);return c}var m,e,d,f,j;this instanceof n?(m=t(k.prototype),f=function(a){var b=m;try{p(b,"constructor",{value:k,enumerable:!1})}catch(c){}k.apply(b,a);return b}):(m=this,f=function(a){return k.apply(m,a)});d=r.call(arguments);j="afterReturning";e=b({target:m,method:c,args:d});try{g._callSimpleAdvice("before",m,d);try{e.result=g._callAroundAdvice(m,c,d,a)}catch(s){e.result=e.exception=s,j="afterThrowing"}d=[e.result];g._callSimpleAdvice(j,m,d);g._callSimpleAdvice("after",m,d);if(e.exception)throw e.exception;
return e.result}finally{h=l.pop()}};p(n,"_advisor",{value:g,configurable:!0})}function f(a,b,c){return(a=d.get(a,b))&&a.add(c)}function j(a,b,c){var k,h,g;k=[];for(g=0;h=b[g++];)(h=f(a,h,c))&&k.push(h);return e(k)}function e(a){return{remove:function(){for(var b=a.length-1;0<=b;--b)a[b].remove()}}}function c(b){return function(c,k,h){var g={};if(2===arguments.length)return g[b]=k,a(c,g);g[b]=h;return a(c,k,g)}}function b(a){l.push(h);return h=a}a.before=c("before");a.around=c("around");a.on=c("on");
a.afterReturning=c("afterReturning");a.afterThrowing=c("afterThrowing");a.after=c("after");a.joinpoint=function(){return h};a.add=function(){return a.apply(null,arguments)};d.prototype={_callSimpleAdvice:function(a,b,c){var k;this.aspects[a]&&(k=m[a],k(this.aspects[a],function(a){(a=a.advice)&&a.apply(b,c)}))},_callAroundAdvice:function(a,c,k,g){function n(k,m,d){function p(a){f++;return 0>m-1?g(a):n(e[m-1].advice,m-1,a)}var f,j;f=0;j=b({target:a,method:c,args:d,proceed:function(){return p(0<arguments.length?
r.call(arguments):d)},proceedApply:function(a){return p(a||d)},proceedCount:function(){return f}});try{return k.call(a,j)}finally{h=l.pop()}}var m,e;m=(e=this.aspects.around)?e.length:0;return 0>m-1?g(k):n(e[m-1].advice,m-1,k)},add:function(a){var b,c;b=this;c=b.aspects;var k,h,g;for(k in m)if(h=a[k])(g=c[k])||(c[k]=g=[]),g.push({aspect:a,advice:h});return{remove:function(){var k,h,g;g=0;for(k in m)if(h=c[k]){g+=h.length;for(var l=h.length-1;0<=l;--l)if(h[l].aspect===a){h.splice(l,1);--g;break}}g||
...
define("curl/plugin/domReady",["curl/domReady"],function(a){return{load:function(q,d,f){a(f)}}});define("curl/plugin/text",["curl/plugin/_fetchText"],function(a){function q(a){throw a;}return{normalize:function(a,f){return a?f(a.split("!")[0]):a},load:function(d,f,j){a(f.toUrl(d),j,j.error||q)},cramPlugin:"../cram/text"}});
(function(a){a("wire/lib/plugin/priority",function(){function a(f,j){var e,c;e=f.priority||d;c=j.priority||d;return e<c?-1:e>c?1:0}var d;d=0;return{basePriority:-99,sortReverse:function(d){return d.sort(a)}}})})("function"===typeof define&&define.amd?define:function(a){module.exports=a()});(function(a){define("wire/domReady",["require"],function(q){return a.require&&a.require.ready||function(a){q(["domReady!"],function(){a()})}})})(this);
...
(function(a){a("cola/network/strategy/validate",function(){function a(d){return{valid:null!=d}}return function(d){var f=d&&d.validator||a;return function(a,e,c,b,h){if(h.isBefore()&&("add"==b||"update"==b))e=f(c),e.valid||h.cancel(),h.queueEvent(a,e,"validate")}}})})("function"==typeof define&&define.amd?define:function(a){module.exports=a()});
...
(function(a){a("cola/adapter/Array",["require","when/when"],function(a,d){function f(a,l){l||(l={});this._options=l;this.comparator=l.comparator||this._defaultComparator;this.identifier=l.identifier||e;"provide"in l&&(this.provide=l.provide);this._array=a;this.clear();var m=this;c(a,function(a){j(m,b);m._init(a)})}function j(a,b,c){var d,g;for(d in b)b.hasOwnProperty(d)&&(g=b[d],a[d]=c?c(g):g);return a}function e(a){return"object"==typeof a?a.id:a}var c,b;c=d;f.prototype={provide:!0,_init:function(a){if(a&&
...
j(a)&&r.test(a.type)?"checked":"value":"textContent"},getNodePropOrAttr:h,setNodePropOrAttr:h}})})("function"==typeof define?define:function(a){module.exports=a(require)});define("highlight/github.css",["curl/plugin/style","require"],function(){return"/*\n\ngithub.com style (c) Vasily Polovnyov <vast@whiteants.net>\n\n*/\n\npre code {\n  display: block; padding: 0.5em;\n  color: #333;\n  background: #fff\n  /*background: #f8f8ff*/\n}\n\npre .comment,\npre .template_comment,\npre .diff .header,\npre .javadoc {\n  color: #998;\n  font-style: italic\n}\n\npre .keyword,\npre .css .rule .keyword,\npre .winutils,\npre .javascript .title,\npre .nginx .title,\npre .subst,\npre .request,\npre .status {\n  color: #333;\n  font-weight: bold\n}\n\npre .number,\npre .hexcolor,\npre .ruby .constant {\n  color: #099;\n}\n\npre .string,\npre .tag .value,\npre .phpdoc,\npre .tex .formula {\n  color: #d14\n}\n\npre .title,\npre .id,\npre .coffeescript .params,\npre .scss .preprocessor {\n  color: #900;\n  font-weight: bold\n}\n\npre .javascript .title,\npre .lisp .title,\npre .clojure .title,\npre .subst {\n  font-weight: normal\n}\n\npre .class .title,\npre .haskell .type,\npre .vhdl .literal,\npre .tex .command {\n  color: #458;\n  font-weight: bold\n}\n\npre .tag,\npre .tag .title,\npre .rules .property,\npre .django .tag .keyword {\n  color: #000080;\n  font-weight: normal\n}\n\npre .attribute,\npre .variable,\npre .lisp .body {\n  color: #008080\n}\n\npre .regexp {\n  color: #009926\n}\n\npre .class {\n  color: #458;\n  font-weight: bold\n}\n\npre .symbol,\npre .ruby .symbol .string,\npre .lisp .keyword,\npre .tex .special,\npre .prompt {\n  color: #990073\n}\n\npre .built_in,\npre .lisp .title,\npre .clojure .built_in {\n  color: #0086b3\n}\n\npre .preprocessor,\npre .pi,\npre .doctype,\npre .shebang,\npre .cdata {\n  color: #999;\n  font-weight: bold\n}\n\npre .deletion {\n  background: #fdd\n}\n\npre .addition {\n  background: #dfd\n}\n\npre .diff .change {\n  background: #0086b3\n}\n\npre .chunk {\n  color: #aaa\n}\n"});
...
b){var c;c=j(a.className,b);a.className=c+(c&&b?" ":"")+b},removeClass:function(a,b){a.className=j(a.className,b)},toggleClass:function(a,b){var c;c=a.className.replace(m,"");a.className=j(a.className,b);c==a.className&&(a.className=c+(c&&b?" ":"")+b)},proxyNode:b}})})("function"==typeof define&&define.amd?define:function(a){module.exports=a(require)});
(function(a){a("wire/lib/WireContext",["require","wire/lib/object"],function(a,d){function f(){}f.inherit=function(a,e){var c;c=d.inherit(a);d.mixin(c,e);f.prototype=c;c=new f;f.prototype=void 0;return c};return f})})("function"===typeof define?define:function(a){module.exports=a(require)});define("app/tabs/structure.css",["curl/plugin/style","require"],function(){return".tabs {\n    position: relative;\n    padding: 0;\n    margin: 0;\n    line-height: 1;\n}\n\n.tabs .item {\n    display: inline-block;\n    list-style-type: none;\n}\n\n.stack {\n    height: 100%;\n    position: relative;\n    padding: 0;\n    margin: 0;\n    clear: both;\n}\n\n.stack .item {\n    display: none;\n    list-style-type: none;\n    position: relative;\n    left: 0;\n    top: 0;\n    right: 0;\n}\n\n.stack .item.active {\n    display: block;\n}"});
define("curl/plugin/css!app/tabs/structure.css",["curl/plugin/style!app/tabs/structure.css"],function(a){return a});(function(a){a("when/sequence",["require","when/when"],function(a,d){return function(a){var j=Array.prototype.slice.call(arguments,1);return d.reduce(a,function(a,c){return d(c.apply(null,j),function(b){a.push(b);return a})},[])}})})("function"===typeof define&&define.amd?define:function(a){module.exports=a(require)});
...
b,c){q(c(b.options),function(a){return d(a.template||a,a.replace,a.at,a.css)}).then(a.resolve,a.reject)}},proxies:[a.proxyNode]};d.wire$plugin=function(){return h};return d});define("contacts/app/edit/structure.css",["curl/plugin/style","require"],function(){return'.edit-contact-view {\n\tpadding: 0;\n\tposition: absolute;\n\tright: 0;\n\theight: 100%;\n\twidth: 70%;\n}\n\n.edit-contact-view fieldset {\n\tmargin: .5em 1em;\n}\n\n.edit-contact-view label {\n\tdisplay: block;\n\twidth: 100%;\n}\n\n.edit-contact-view label span {\n    display: inline-block;\n    padding: 0 2px;\n    width: 7em;\n}\n\n.edit-contact-view input[type="text"] {\n\twidth: 8em;\n}\n\n.edit-contact-view input[name="id"] {\n    display: none;\n}\n\n.edit-contact-view .controls {\n    position: absolute;\n    bottom: 0;\n}\n'});
define("curl/plugin/css!contacts/app/edit/structure.css",["curl/plugin/style!contacts/app/edit/structure.css"],function(a){return a});
...
define("wire/lib/plugin-base/dom",["wire/domReady","when/when","wire/lib/dom/base","wire/lib/object"],function(a,q,d,f){function j(a,c,b){q(b(c.options),function(a){if(!a||!a.nodeType||!a.tagName)throw Error("dom: non-element reference provided to element factory");return a}).then(a.resolve,a.reject)}return function(e){function c(a,b){var c;if(!b)return a.resolve(g);(c=g(b))?a.resolve(c):a.reject(Error("No DOM node with id: "+b))}function b(a,b,c){var k,d,g;d=b.options;k=b.target;for(var h in d)if(f.hasOwn(d,
h)){g=h;break}b=c("string"==typeof d[g]?{$ref:d[g]}:d[g]);q(b,function(a){return s(k,a,g)}).then(a.resolve,a.reject)}function h(a,b,c,k,d){var g;d||(d=p);if(!b)return a.resolve(d);c.at&&!c.isRoot&&(g=k(m(c.at)));q(g,function(a){var k;k=d;a=k(b,a);if("undefined"!=typeof c.i)if(k=c.i,a[k])k=a[k];else throw Error("Query '"+b+"' did not find an item at position "+k);else{if(k==t&&!a)throw Error("Query '"+b+"' did not find anything");k=a}return k}).then(a.resolve,a.reject)}function l(a,b,c,k){v(a,b,c,
k,t)}function m(a){if(a="string"==typeof a?{$ref:a}:a)a.isRoot=!0;return a}function r(a,b){return function(c,k,d,g){d.at=d.at?m(d.at):b.at;return a(c,k,d,g)}}var g,p,t,n,k,s,u,w,v;g=e.byId||d.byId;p=e.query||d.querySelectorAll;t=e.first||d.querySelector;n=e.addClass;s=e.placeAt||d.placeAt;k=e.removeClass;u=function(b,k){a(function(){u=c;c(b,k)})};w=function(c,k,d){a(function(){w=b;b(c,k,d)})};v=function(b,c,k,d,g){a(function(){v=h;h(b,c,k,d,g)})};return function(b){var c,g,h,e,f,s;b.at=m(b.at);c=
b.classes;f={};c&&(a(function(){s=document.getElementsByTagName("html")[0]}),f.initialize=function(b){a(function(){var a=s,k=c.init;k&&n(a,k);b.resolve()})},f.ready=function(b){a(function(){var a=s,d=c.ready,g=c.init;d&&n(a,d);g&&k(a,g);b.resolve()})},c.ready&&(f.destroy=function(b){a(function(){var a=s,d=c.ready;d&&k(a,d);b.resolve()})}));e={element:j};h={insert:{initialize:w}};g={};g.id=g.dom=u;p&&(g.first=r(l,b),g["dom.first"]=function(){g.first.apply(g,arguments)},g.all=g.query=r(v,b),g["dom.all"]=
g["dom.query"]=function(){g.query.apply(g,arguments)});return{context:f,resolvers:g,facets:h,factories:e,proxies:[d.proxyNode]}}}});define("contacts/app/list/structure.css",["curl/plugin/style","require"],function(){return".contact-list-view {\n\tposition: absolute;\n\theight: 100%;\n\twidth: 30%;\n    margin: 0;\n    padding: 0;\n}\n\n.contact-list-view .contact {\n    padding: .25em;\n\tlist-style: none;\n}\n\n.contact-list-view {\n\toverflow-y: auto;\n}\n\n.contact-list-view .remove {\n    color: #aaa;\n    opacity: 0;\n}\n\n.contact-list-view .contact:hover .remove {\n    opacity: 1;\n}"});
...
(function(a){a("cola/dom/adapter/NodeList",["require","cola/SortedMap","cola/dom/classList","cola/dom/adapter/Node"],function(a,d,f,j){function e(a,d){var e,l;d||(d={});this._options=d;this.comparator=d.comparator;this.identifier=d.identifier;this._rootNode=a;e=d;var k,f;k=!e.itemTemplateSelector;e.querySelector&&(f=e.querySelector(e.itemTemplateSelector||b,a),!f&&k&&(f=e.querySelector(h,a)));!f&&k&&(f=a.firstChild);if(!f)throw Error("NodeListAdapter: could not find itemTemplate node");this._templateNode=
f;e=d.containerNode||this._templateNode.parentNode;if(!e)throw Error("No container node found for NodeListAdapter.");this._containerNode=e;this._initTemplateNode();this._itemCount=r;this._checkBoundState();l=this;this._itemData=new c(function(a){return l.identifier(a)},function(a,b){return l.comparator(a,b)});this._itemsById={}}var c,b,h,l,m,r;c=d;b='[data-cola-role="item-template"]';h="tr,li";l={empty:"cola-list-empty",bound:"cola-list-bound",unbound:"cola-list-unbound"};m=Object.keys(l).map(function(a){return l[a]}).join(" ");
...
define("contacts/theme/basic.css",["curl/plugin/style","require"],function(){return".cujo-contacts fieldset {\n\tborder: none;\n}\n\n.cujo-contacts input[type=\"text\"] {\n    font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif;\n    font-size: 1em;\n    margin: .5em 0 1em 0;\n}\n\n::-webkit-input-placeholder {\n    color: #acacac;\n}\n:-moz-placeholder {\n    color: #acacac;\n}\n::-moz-placeholder {\n    color: #acacac;\n}\n:-ms-input-placeholder {\n    color: #acacac;\n}\n\n.cujo-contacts label {\n    color: #acacac;\n    font-weight: normal;\n}\n\n.cujo-contacts {\n\twidth: auto;\n    margin: 0 auto;\n\toverflow: visible;\n}\n\n.cujo-contacts  .contacts-view-container {\n\tposition: relative;\n\theight: 100%;\n\twidth: auto;\n\tmin-height: 400px;\n\toverflow: hidden;\n\tclear: both;\n}\n\n.cujo-contacts .contact-list-view {\n    background-color: #fafafa;\n    cursor: pointer;\n}\n"});
define("curl/plugin/css!contacts/theme/basic.css",["curl/plugin/style!contacts/theme/basic.css"],function(a){return a});define("wire/dom",["wire/lib/plugin-base/dom","wire/lib/dom/base"],function(a,q){return a({addClass:q.addClass,removeClass:q.removeClass})});
...
(function(a){a("wire/lib/connection",["require","when/when","wire/lib/array","wire/lib/functional"],function(a,d,f,j){function e(a,c,d,e,f,j,k){var s;c?e=h(l.compose.parse(d,f,j),function(e){return k(a,c,b(d,e))}):(a=s,e=h(j.resolveRef(e),function(a){function c(a,d,g){return function(c){return k(a,d,b(g,c))}}var e,m;m=[];for(e in f)m.push(h(l.compose.parse(d,f[e],j),c(a,e,d)));return h.all(m)}));return e}function c(a,c,d,e,f){var j=a.target,k=function(a,d){return h(l.compose.parse(a,d,e),function(d){return f(j,
c,b(a,d))})},s,u;if("string"==typeof d)d=k(a,d);else{a=[];s=function(a,b){return h(e.getProxy(a),function(a){return k(a,b)})};for(u in d)a.push(s(u,d[u]));d=h.all(a)}return d}function b(a,b){return function(){return a.invoke(b,arguments)}}var h,l;h=d;l=j;return{parse:function(a,b,d,f,l){var j,k;j=b.split(".");k=j[1];j=j[0];return h(f.resolveRef(j),function(c){return e(c,k,a,b,d,f,l)},function(){return c(a,b,d,f,l)})},parseIncoming:e,parseOutgoing:c}})})("function"==typeof define?define:function(a){module.exports=
a(require)});
(function(a){a("wire/aop",["require","meld/meld","when/when","when/sequence","wire/lib/connection"],function(a,d,f,j,e){function c(a,b,c){return function(d){return s(c.resolveRef(a),function(a){var k;b?k=s(c(b),function(b){b=b?[d].concat(b):[d];a.apply(null,b)}):(k=(k=void 0,[d]),a.apply(null,k),k=void 0);return k})}}function b(a,b,d){var k,g;k=b.target;b=b.options;g=[];for(var e in b)g.push(c(e,b[e],d));a.resolve(u(g,k))}function h(a,b,c,d,k,g){return w.parse(c,d,k,g,function(c,d,k){if(!("function"==typeof d||
"function"==typeof c[d]))throw new TypeError("Cannot add advice to non-method: "+d);b.push(a(c,d,k))})}function l(a){return function(b,c,d){return k[a](b,c,d)}}function m(a,b,c){return k.afterReturning(a,b,function(a){return s(a,c)})}function r(a,b,c){return k.afterReturning(a,b,function(a){return s(a,null,c)})}function g(a,b,c){return k.after(a,b,function(a){return s(a,c,c)})}function p(a,b){return function(c,d,k){var g,e,f;e=d.options;f=[];for(g in e)f.push(h(a,b,d,g,e[g],k));c.resolve(s.all(f))}}
function t(a,b,c,d){return s(c.resolveRef(b),function(b){var c=b.pointcut;c&&d(a,c,b);return a})}function n(a,b,c,d){function k(b){return s(c.resolveRef(e),function(c){d(a,b,c);return a})}var g,e;g=b.pointcut;e=b.advice;return"string"===typeof g?s(c.resolveRef(g,k)):k(g)}var k,s,u,w,v;k=d;s=f;u=j;w=e;v=["before","around","afterReturning","afterThrowing"];return function(a){function c(a,b,d){e.push(k.add(a,b,d))}function d(a,b){var c={};c[a]=function(a,c,d){b(a,c,d)};return c}var e,h,f,j,u;e=[];h=
{context:{destroy:function(a){e.forEach(function(a){a.remove()});a.resolve()}},facets:{decorate:d("configure:after",b),afterFulfilling:d("connect:before",p(m,e)),afterRejecting:d("connect:before",p(r,e)),after:d("connect:before",p(g,e))}};a.aspects&&(h.create=function(b,d,k){var g,e,h;e=a.aspects;g=d.path;!e||void 0===g?b.resolve():(d=d.target,h=t,b.resolve(s.reduce(e,function(a,b){var d;b.advice?(d=b.advice,h=n):d=b;return"string"===typeof d&&d!==g?h(a,b,k,c):a},d)))});f=0;for(j=v.length;f<j;f++)u=
v[f],h.facets[u]=d("connect:before",p(l(u),e));return h}})})("function"==typeof define?define:function(a){module.exports=a(require)});
...
a[d]}}var l,m,r;l=j;m="$ns";r=":";c.prototype={scanModule:function(a,c,e){var h,k;"function"===typeof a.wire$plugin?k=a.wire$plugin:"function"===typeof a&&(k=a);a=k;if(!("function"===typeof a&&-1===this.plugins.indexOf(a)))return d.resolve();this.plugins.push(a);h=this;return d(a(c),function(a){a&&h.registerPlugin(a,e||b(c))}).yield()},registerPlugin:function(a,b){var c=this._namespaces;if(b&&b in c)throw Error("plugin namespace already in use: "+b);c[b]=1;h(a.resolvers,this.resolvers,b);h(a.factories,
...
(function(a){a("wire/lib/plugin-base/on",["when/when","when/apply","wire/lib/functional","wire/lib/connection"],function(a,d,f,j){function e(a){var b,d,e;if(b=a.selectorTarget||a.target||a.srcElement)d=b.tagName,e=b.type&&b.type.toLowerCase(),(b="click"==a.type&&"A"==d||"submit"==e&&b.form||"submit"==a.type&&"FORM"==d)&&c(a)}function c(a){a.preventDefault()}function b(a){a.stopPropagation()}function h(){}function l(a,d,g){var f,l;f=d==t||"auto"==d?e:d?c:h;l=g?b:h;return function(b){f(b);l(b);return a.apply(this,
arguments)}}function m(a,b){var c,d;c=a.split(":",2);d=c[0];c=c[1]||b;if(g.test(d))throw Error("on! resolver: malformed event-selector string (event missing?)");d=d.split(p);c&&(d.selector=c);return d}var r,g,p,t;r={selector:1,transform:1,preventDefault:1,stopPropagation:1};g=/#|\.|-|[^,]\s[^,]/;p=/\s*,\s*/;return function(b){function c(a,b,d,k,g){var h,f;h=[];for(var j=0,m=a.length;j<m;j++)f=l(d,k,g),h.push(e(b,a[j],f,a.selector));return h}function d(a){var b;b=m(a,"");return function(){var a,c,
d,k;a=Array.prototype.slice.call(arguments,0,3);c=1<a.length?a.shift():document;d=a[0];k=[];b.forEach(function(a){k.push(e(c,a,d,b.selector))});return function(){k.forEach(function(a){a()})}}}var e;e=b.on;return function(b){function g(a,d,e){d=m(d);n=n.concat(c(d,a,e,b.preventDefault,b.stopPropagation))}function h(d,e,l,s){return a(s.resolveRef(e),function(e){var h=function(b,g,h){return a(h,function(a){var h=f.compose([a,g]).bind(d.target);n=n.concat(c(b,e,function(){return d.invoke(h,arguments)},
z,B))})},u,p,t,x,z,B,F,D,C;u=d.target;C=[];x=l.selector;D=l.transform;z=l.preventDefault||b.preventDefault;B=l.stopPropagation||b.stopPropagation;for(p in l)p in r||(D?(t=m(p,x),F=l[p],C.push(h(t,u[F],s(D)))):C.push(j.parseIncoming(e,p,d,b,l[p],s,g)));return a.all(C)},function(){return j.parseOutgoing(d,e,l,s,g)})}function l(b,c){var d,k;k=c.options;d=[];for(var e in k)d.push(h(c,e,k[e],b));return a.all(d)}var n=[];b||(b={});return{context:{destroy:function(a){n.forEach(function(a){a()});a.resolve()}},
facets:{on:{connect:function(a,b,c){a.resolve(l(c,b))}}},resolvers:{on:function(a,b){a.resolve(b?d(b):e)}}}}}})})("function"==typeof define&&define.amd?define:function(a,q){module.exports=q.apply(this,a.map(require))});
...
(function(a){a("wire/lib/lifecycle",["require","when/when"],function(a,d){function f(a,b){this._plugins=a;this._pluginApi=b}function j(a){a=a.reduce(c,[]);return function(c){var d,g;d=this._plugins;g=this._pluginApi.contextualize(c.id);return b.reduce(a,function(a,f){var j;var k,l,u,q,v,x;j=[];u=c.metadata.spec;q=d.facets;v=Object.create(d.factories,h);x=[];for(l in u)l in q?(k=u[l])&&e(j,q[l],f,c,k,g):l in v||x.push(l);j=x.length?b.reject(Error("unrecognized facets in "+c.id+", maybe you forgot a plugin? "+
x.join(", ")+"\n"+JSON.stringify(u))):b.all(j).then(function(){for(var a=d.listeners,k=[],h=0;h<a.length;h++)e(k,a[h],f,c,{},g);return b.all(k)}).yield(c);return j},c)}}function e(a,c,d,e,f,h){var j;c&&c[d]&&(j=b.defer(),a.push(j.promise),a=Object.create(e),a.options=f,c[d](j.resolver,a,h))}function c(a,b){a.push(b+":before");a.push(b);a.push(b+":after");return a}var b,h;b=d;h={id:{value:1}};f.prototype={init:j(["create","configure","initialize"]),startup:j(["connect","ready"]),shutdown:j(["destroy"])};
...
b;for(a=this.adapters;b=a.pop();)"function"==typeof b.destroy&&b.destroy()},addApi:function(a){this._addApiMethod(a);this._addApiEvent(a)},_createAdapterProxy:function(a,c){var d,e,f,g;g=Object.create(a);"provide"in c&&(g.provide=c.provide);d=this.configureEventFinder(c.eventNames);for(e in a)f=a[e],"function"==typeof f&&d(e)&&(g[e]=b(a,f),h(this.eventProcessor,a,e,f),this.addApi(e));return g},configureEventFinder:function(a){var b=this.eventTypes;return"function"==typeof a?a:function(a){return a in
b}},_addApiMethod:function(a){var b,c,d;b=this.adapters;d=this.eventProcessor;c=this;this[a]||(this[a]=function(e,f){var g;g=c._findItemFor(e);if(!g){var h,j;for(g=0;!j&&(h=b[g++]);)h.origSource==f&&(j=h);g={item:e,source:j}}return d.queueEvent(g.source,g.item,a)})},_addApiEvent:function(a){var b=this.eventProcessor.makeEventName(a);this[b]||(this[b]=function(){});b=this.eventProcessor.makeBeforeEventName(a);this[b]||(this[b]=function(){})},_findItemFor:function(a){var b,c,d,e;d=this.adapters;for(c=
...
d){var e,k;e=c._createComponentDef(d);k=c.componentFactory.processComponent(e,b);return c._makeResolvable(e,k)}function b(a,d){c._makeResolvable(c._createComponentDef(d),a);return p.resolve(a)}var c;c=this;return{contextualize:function(d){function e(a,b){return c._resolveItem(c._createComponentDef(b,a))}e.createChild=c._createChild.bind(c);e.loadModule=c.getModule.bind(c);e.resolver=c.resolver;e.addComponent=a;e.addInstance=b;e.resolveRef=function(a){return c._resolveRef(a,1<arguments.length?arguments[2]:
