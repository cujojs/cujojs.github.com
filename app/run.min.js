(function(){/*
 MIT License (c) copyright B Cavalier & J Hann  MIT License (c) copyright 2011-2013 original author or authors  MIT License (c) copyright 2011-2013 original author or authors  MIT License (c) copyright B Cavalier & J Hann  MIT License (c) copyright B Cavalier & J Hann  MIT License (c) copyright 2010-2013 original author or authors  MIT License (c) copyright B Cavalier & J Hann  MIT License (c) copyright B Cavalier & J Hann  MIT License (c) copyright B Cavalier & J Hann  MIT License (c) copyright B Cavalier & J Hann  MIT License (c) copyright B Cavalier & J Hann  MIT License (c) copyright original author or authors  MIT License (c) copyright B Cavalier & J Hann  MIT License (c) copyright B Cavalier & J Hann  MIT License (c) copyright B Cavalier & J Hann  MIT License (c) copyright B Cavalier & J Hann  MIT License (c) copyright B Cavalier & J Hann  MIT License (c) copyright B Cavalier & J Hann  MIT License (c) copyright B Cavalier & J Hann  MIT License (c) copyright B Cavalier & J Hann  MIT License (c) copyright B Cavalier & J Hann  MIT License (c) copyright B Cavalier & J Hann  MIT License (c) copyright B Cavalier & J Hann  MIT License (c) copyright B Cavalier & J Hann  MIT License (c) copyright 2010-2013 original author or authors  MIT License (c) copyright B Cavalier & J Hann  MIT License (c) copyright B Cavalier & J Hann  MIT License (c) copyright B Cavalier & J Hann  MIT License (c) copyright B Cavalier & J Hann  MIT License (c) copyright 2010-2013 original author or authors  MIT License (c) copyright B Cavalier & J Hann  MIT License (c) copyright B Cavalier & J Hann  MIT License (c) copyright B Cavalier & J Hann  MIT License (c) copyright B Cavalier & J Hann  MIT License (c) copyright B Cavalier & J Hann  MIT License (c) copyright B Cavalier & J Hann  MIT License (c) copyright B Cavalier & J Hann  MIT License (c) copyright B Cavalier & J Hann  MIT License (c) copyright B Cavalier & J Hann */
...
bind:{$ref:"homepageSources"}},$plugins:["wire/dom","wire/on","cola"]});define("curl/plugin/text!app/subheader/template.html",function(){return"<h2>${text}</h2>\n"});(function(a){a("app/subheader/selectText",function(){function a(d){return Math.floor(Math.random()*d)}return function(d,f){var j=d&&d.length;return j?d[(f||a)(j)]:""}})})("function"===typeof define&&define.amd?define:function(a){module.exports=a()});
...
define("curl/plugin/style",function(){function a(l,m,d){try{clearTimeout(a.debouncer),a.accum?a.accum.push(l):(a.accum=[l],b=e.createStyleSheet?e.createStyleSheet():c.appendChild(e.createElement("style"))),h.push({callback:m,errback:d,sheet:b}),a.debouncer=setTimeout(function(){var c,h;try{c=b;b=j;h=a.accum.join("\n");a.accum=j;h=h.replace(/.+charset[^;]+;/g,"");"cssText"in c?c.cssText=h:c.appendChild(e.createTextNode(h));var g=q,k=function(){!e.readyState||"complete"==e.readyState?g():setTimeout(k,
...
c,h,g,l){n(2,arguments);return a(b,function(b){return j(function(h,g,l){function n(a){s(a)}function m(a){j(a)}var d,e,p,f,j,s,u,t;u=b.length>>>0;d=Math.max(0,Math.min(c,u));p=[];e=u-d+1;f=[];if(d){s=function(a){f.push(a);--e||(j=s=k,g(f))};j=function(a){p.push(a);--d||(j=s=k,h(p))};for(t=0;t<u;++t)t in b&&a(b[t],m,n,l)}else h(p)}).then(h,g,l)})}function r(a,b,c,k){n(1,arguments);return g(a,s).then(b,c,k)}function g(b,c){return a(b,function(b){return j(function(k,h,g){var l,n,m,d,e;m=n=b.length>>>
0;l=[];if(m){d=function(b,n){a(b,c).then(function(a){l[n]=a;--m||k(l)},h,g)};for(e=0;e<n;e++)e in b?d(b[e],e):--m}else k(l)})})}function p(a){1===z.push(a)&&x(t)}function t(){for(var a,b=0;a=z[b++];)a();z=[]}function n(a,b){for(var c,k=b.length;k>a;)if(c=b[--k],null!=c&&"function"!=typeof c)throw Error("arg "+k+" must be a function");}function k(){}function s(a){return a}a.defer=function(){var a,c,k;a={promise:y,resolve:y,reject:y,notify:y,resolver:{resolve:y,reject:y,notify:y}};a.promise=c=j(function(h,
...
define("curl/plugin/domReady",["curl/domReady"],function(a){return{load:function(q,d,f){a(f)}}});(function(a){define("wire/domReady",["require"],function(q){return a.require&&a.require.ready||function(a){q(["domReady!"],function(){a()})}})})(this);
...
define("curl/plugin/text",["curl/plugin/_fetchText"],function(a){function q(a){throw a;}return{normalize:function(a,f){return a?f(a.split("!")[0]):a},load:function(d,f,j){a(f.toUrl(d),j,j.error||q)},cramPlugin:"../cram/text"}});
...
(function(a){a("cola/network/strategy/changeEvent",function(){var a,d;a={sync:1};d={add:1,update:1,remove:1};return function(){return function(f,j,e,c,b){(b.isBefore()&&a[c]||b.isAfter()&&d[c])&&b.queueEvent(f,e,"change")}}})})("function"==typeof define&&define.amd?define:function(a){module.exports=a()});(function(a){a("cola/identifier/property",function(){return function(a){return function(d){return d&&d[a]}}})})("function"==typeof define?define:function(a){module.exports=a()});
...
b=/^\s+/,h=/(\b\s+\b)|(\s+)/g,l,m,r,g,p;l="(?:\\b\\s+|^\\s*)(";m=")(?:\\b(?!-))|(?:\\s*)$";r="|";g=/\b\s+\b/;p=/^\s+|\s+$/;return{addClass:function(a,b){var c=j(a,b);c&&a&&(c+=" ");return c+a},removeClass:j,getClassList:a,setClassList:function(b,c){var k,h;c&&(k=c.add||c||[],h=c.remove||[],b.className=d(b.className,h,k));return a(b)},getClassSet:function(a){var b,c;b={};for(a=a.className.split(e);c=a.pop();)b[c]=!0;return b},setClassSet:function(a,b){var c,h,g;c=[];h=[];for(g in b)g&&(b[g]?h.push(g):
c.push(g));return a.className=d(a.className,c,h)}}})})("function"==typeof define?define:function(a){module.exports=a(require)});(function(a){a("cola/network/strategy/base",function(){return function(){return function(a,d,f,j,e){if(e.isPropagating()&&j in d&&!e.isHandled()){if("function"!=typeof d[j])throw Error("baseStrategy: "+j+" is not a function.");return d[j](f)}}}})})("function"==typeof define&&define.amd?define:function(a){module.exports=a()});
...
(function(a){a("cola/comparator/byProperty",["require","cola/comparator/naturalOrder"],function(a,d){return function(a,j){j||(j=d);return function(d,c){return j(d[a],c[a])}}})})("function"==typeof define?define:function(a){module.exports=a(require)});
...
(function(a){a("cola/identifier/default",["require","cola/identifier/property"],function(a,d){return d("id")})})("function"==typeof define?define:function(a){module.exports=a(require)});
...
return a},clear:function(){this._storage.removeItem(this._namespace)},_sync:function(){this._storage.setItem(this._namespace,JSON.stringify(this._data))}};return j})})(this.window||global,"function"==typeof define?define:function(a){module.exports=a(require)});define("highlight/github.css",["curl/plugin/style","require"],function(){return"/*\n\ngithub.com style (c) Vasily Polovnyov <vast@whiteants.net>\n\n*/\n\npre code {\n  display: block; padding: 0.5em;\n  color: #333;\n  background: #fff\n  /*background: #f8f8ff*/\n}\n\npre .comment,\npre .template_comment,\npre .diff .header,\npre .javadoc {\n  color: #998;\n  font-style: italic\n}\n\npre .keyword,\npre .css .rule .keyword,\npre .winutils,\npre .javascript .title,\npre .nginx .title,\npre .subst,\npre .request,\npre .status {\n  color: #333;\n  font-weight: bold\n}\n\npre .number,\npre .hexcolor,\npre .ruby .constant {\n  color: #099;\n}\n\npre .string,\npre .tag .value,\npre .phpdoc,\npre .tex .formula {\n  color: #d14\n}\n\npre .title,\npre .id,\npre .coffeescript .params,\npre .scss .preprocessor {\n  color: #900;\n  font-weight: bold\n}\n\npre .javascript .title,\npre .lisp .title,\npre .clojure .title,\npre .subst {\n  font-weight: normal\n}\n\npre .class .title,\npre .haskell .type,\npre .vhdl .literal,\npre .tex .command {\n  color: #458;\n  font-weight: bold\n}\n\npre .tag,\npre .tag .title,\npre .rules .property,\npre .django .tag .keyword {\n  color: #000080;\n  font-weight: normal\n}\n\npre .attribute,\npre .variable,\npre .lisp .body {\n  color: #008080\n}\n\npre .regexp {\n  color: #009926\n}\n\npre .class {\n  color: #458;\n  font-weight: bold\n}\n\npre .symbol,\npre .ruby .symbol .string,\npre .lisp .keyword,\npre .tex .special,\npre .prompt {\n  color: #990073\n}\n\npre .built_in,\npre .lisp .title,\npre .clojure .built_in {\n  color: #0086b3\n}\n\npre .preprocessor,\npre .pi,\npre .doctype,\npre .shebang,\npre .cdata {\n  color: #999;\n  font-weight: bold\n}\n\npre .deletion {\n  background: #fdd\n}\n\npre .addition {\n  background: #dfd\n}\n\npre .diff .change {\n  background: #0086b3\n}\n\npre .chunk {\n  color: #aaa\n}\n"});
...
define("curl/plugin/css!app/tabs/structure.css",["curl/plugin/style!app/tabs/structure.css"],function(a){return a});
...
define.amd?define:function(a){module.exports=a(require)});(function(a){a("when/sequence",["require","when/when"],function(a,d){return function(a){var j=Array.prototype.slice.call(arguments,1);return d.reduce(a,function(a,c){return d(c.apply(null,j),function(b){a.push(b);return a})},[])}})})("function"===typeof define&&define.amd?define:function(a){module.exports=a(require)});
...
return{load:f,merge:function(a){return e(a,function(a){return e.resolve(Array.isArray(a)?j(a,f):"string"===typeof a?f(a):a)})}}}})})("function"===typeof define?define:function(a){module.exports=a(require)});define("contacts/theme/basic.css",["curl/plugin/style","require"],function(){return".cujo-contacts fieldset {\n\tborder: none;\n}\n\n.cujo-contacts input[type=\"text\"] {\n    font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif;\n    font-size: 1em;\n    margin: .5em 0 1em 0;\n}\n\n::-webkit-input-placeholder {\n    color: #acacac;\n}\n:-moz-placeholder {\n    color: #acacac;\n}\n::-moz-placeholder {\n    color: #acacac;\n}\n:-ms-input-placeholder {\n    color: #acacac;\n}\n\n.cujo-contacts label {\n    color: #acacac;\n    font-weight: normal;\n}\n\n.cujo-contacts {\n\twidth: auto;\n    margin: 0 auto;\n\toverflow: visible;\n}\n\n.cujo-contacts  .contacts-view-container {\n\tposition: relative;\n\theight: 100%;\n\twidth: auto;\n\tmin-height: 400px;\n\toverflow: hidden;\n\tclear: both;\n}\n\n.cujo-contacts .contact-list-view {\n    background-color: #fafafa;\n    cursor: pointer;\n}\n"});
...
arguments)}}function m(a,b){var c,d;c=a.split(":",2);d=c[0];c=c[1]||b;if(g.test(d))throw Error("on! resolver: malformed event-selector string (event missing?)");d=d.split(p);c&&(d.selector=c);return d}var r,g,p,t;r={selector:1,transform:1,preventDefault:1,stopPropagation:1};g=/#|\.|-|[^,]\s[^,]/;p=/\s*,\s*/;return function(b){function c(a,b,d,k,h){var g,f;g=[];for(var j=0,m=a.length;j<m;j++)f=l(d,k,h),g.push(e(b,a[j],f,a.selector));return g}function d(a){var b;b=m(a,"");return function(){var a,c,
d,k;a=Array.prototype.slice.call(arguments,0,3);c=1<a.length?a.shift():document;d=a[0];k=[];b.forEach(function(a){k.push(e(c,a,d,b.selector))});return function(){k.forEach(function(a){a()})}}}var e;e=b.on;return function(b){function h(a,d,e){d=m(d);n=n.concat(c(d,a,e,b.preventDefault,b.stopPropagation))}function g(d,e,l,s){return a(s.resolveRef(e),function(e){var g=function(b,h,g){return a(g,function(a){var g=f.compose([a,h]).bind(d.target);n=n.concat(c(b,e,function(){return d.invoke(g,arguments)},
z,B))})},u,p,t,x,z,B,F,D,C;u=d.target;C=[];x=l.selector;D=l.transform;z=l.preventDefault||b.preventDefault;B=l.stopPropagation||b.stopPropagation;for(p in l)p in r||(D?(t=m(p,x),F=l[p],C.push(g(t,u[F],s(D)))):C.push(j.parseIncoming(e,p,d,b,l[p],s,h)));return a.all(C)},function(){return j.parseOutgoing(d,e,l,s,h)})}function l(b,c){var d,k;k=c.options;d=[];for(var e in k)d.push(g(c,e,k[e],b));return a.all(d)}var n=[];b||(b={});return{context:{destroy:function(a){n.forEach(function(a){a()});a.resolve()}},
...
x.join(", ")+"\n"+JSON.stringify(u))):b.all(l).then(function(){for(var a=d.listeners,k=[],h=0;h<a.length;h++)e(k,a[h],f,c,{},g);return b.all(k)}).yield(c);return l},c)}}function e(a,c,d,e,h,f){var j;c&&c[d]&&(j=b.defer(),a.push(j.promise),a=Object.create(e),a.options=h,c[d](j.resolver,a,f))}function c(a,b){a.push(b+":before");a.push(b);a.push(b+":after");return a}var b,h;b=d;h={id:{value:1}};f.prototype={init:j(["create","configure","initialize"]),startup:j(["connect","ready"]),shutdown:j(["destroy"])};
