(function(){/*
 MIT License (c) copyright B Cavalier & J Hann  MIT License (c) copyright 2011-2013 original author or authors  MIT License (c) copyright 2011-2013 original author or authors  MIT License (c) copyright B Cavalier & J Hann  MIT License (c) copyright 2010-2013 original author or authors  MIT License (c) copyright B Cavalier & J Hann  MIT License (c) copyright B Cavalier & J Hann  MIT License (c) copyright B Cavalier & J Hann  MIT License (c) copyright B Cavalier & J Hann  MIT License (c) copyright B Cavalier & J Hann  MIT License (c) copyright B Cavalier & J Hann  MIT License (c) copyright original author or authors  MIT License (c) copyright B Cavalier & J Hann  MIT License (c) copyright B Cavalier & J Hann  MIT License (c) copyright B Cavalier & J Hann  MIT License (c) copyright B Cavalier & J Hann  MIT License (c) copyright B Cavalier & J Hann  MIT License (c) copyright B Cavalier & J Hann  MIT License (c) copyright B Cavalier & J Hann  MIT License (c) copyright B Cavalier & J Hann  MIT License (c) copyright B Cavalier & J Hann  MIT License (c) copyright B Cavalier & J Hann  MIT License (c) copyright B Cavalier & J Hann  MIT License (c) copyright 2010-2013 original author or authors  MIT License (c) copyright B Cavalier & J Hann  MIT License (c) copyright B Cavalier & J Hann  MIT License (c) copyright B Cavalier & J Hann  MIT License (c) copyright B Cavalier & J Hann  MIT License (c) copyright B Cavalier & J Hann  MIT License (c) copyright 2010-2013 original author or authors  MIT License (c) copyright B Cavalier & J Hann  MIT License (c) copyright B Cavalier & J Hann  MIT License (c) copyright B Cavalier & J Hann  MIT License (c) copyright B Cavalier & J Hann  MIT License (c) copyright B Cavalier & J Hann  MIT License (c) copyright B Cavalier & J Hann  MIT License (c) copyright B Cavalier & J Hann  MIT License (c) copyright B Cavalier & J Hann  MIT License (c) copyright B Cavalier & J Hann */
...
define("curl/plugin/domReady",["curl/domReady"],function(a){return{load:function(q,d,f){a(f)}}});
...
j(a)&&r.test(a.type)?"checked":"value":"textContent"},getNodePropOrAttr:h,setNodePropOrAttr:h}})})("function"==typeof define?define:function(a){module.exports=a(require)});define("app/tabs/structure.css",["curl/plugin/style","require"],function(){return".tabs {\n    position: relative;\n    padding: 0;\n    margin: 0;\n    line-height: 1;\n}\n\n.tabs .item {\n    display: inline-block;\n    list-style-type: none;\n}\n\n.stack {\n    height: 100%;\n    position: relative;\n    padding: 0;\n    margin: 0;\n    clear: both;\n}\n\n.stack .item {\n    display: none;\n    list-style-type: none;\n    position: relative;\n    left: 0;\n    top: 0;\n    right: 0;\n}\n\n.stack .item.active {\n    display: block;\n}"});
...
define.amd?define:function(a){module.exports=a(require)});define("contacts/app/list/structure.css",["curl/plugin/style","require"],function(){return".contact-list-view {\n\tposition: absolute;\n\theight: 100%;\n\twidth: 30%;\n    margin: 0;\n    padding: 0;\n}\n\n.contact-list-view .contact {\n    padding: .25em;\n\tlist-style: none;\n}\n\n.contact-list-view {\n\toverflow-y: auto;\n}\n\n.contact-list-view .remove {\n    color: #aaa;\n    opacity: 0;\n}\n\n.contact-list-view .contact:hover .remove {\n    opacity: 1;\n}"});
...
b,c){q(c(b.options),function(a){return d(a.template||a,a.replace,a.at,a.css)}).then(a.resolve,a.reject)}},proxies:[a.proxyNode]};d.wire$plugin=function(){return h};return d});(function(a){a("when/sequence",["require","when/when"],function(a,d){return function(a){var j=Array.prototype.slice.call(arguments,1);return d.reduce(a,function(a,c){return d(c.apply(null,j),function(b){a.push(b);return a})},[])}})})("function"===typeof define&&define.amd?define:function(a){module.exports=a(require)});
...
a.resolve(c)},invoker:function(a,b,d){b=d(b.options).then(function(a){return c(a.method,a.args)});a.resolve(b)}},facets:{properties:{configure:function(a,b,c){var d,e,f;d=b.options;e=b.set.bind(b);f=r.map(Object.keys(b.options),function(a){return c(d[a],b.path).then(function(b){e(a,b)})});a.resolve(f)}},mixin:{configure:function(a,b,c){var d;d=b.target;b=b.options;Array.isArray(b)||(b=[b]);a.resolve(r.reduce(b,function(a,b){var d=b,d="string"==typeof d?c.resolveRef(d):c(d);return r(d,l.bind(null,
...
d){var e,f;e=c._createComponentDef(d);f=c.componentFactory.processComponent(e,b);return c._makeResolvable(e,f)}function b(a,d){c._makeResolvable(c._createComponentDef(d),a);return p.resolve(a)}var c;c=this;return{contextualize:function(d){function e(a,b){return c._resolveItem(c._createComponentDef(b,a))}e.createChild=c._createChild.bind(c);e.loadModule=c.getModule.bind(c);e.resolver=c.resolver;e.addComponent=a;e.addInstance=b;e.resolveRef=function(a){return c._resolveRef(a,1<arguments.length?arguments[2]:
